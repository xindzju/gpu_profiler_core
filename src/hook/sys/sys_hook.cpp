...
namespace gpc {
    bool HookSysEntry() {
        ...
        */
        ...
        auto apiHookInfo = GetAPIHookInfo("CreateProcessW");
        res &= HookFunc(&::CreateProcessW, My_CreateProcessW, (void**)&pReal_CreateProcessW, apiHookInfo);
        if (res)
...
#pragma region HookCreateProcessW
    PFN_CreateProcessW pReal_CreateProcessW = Real_CreateProcessW;
    ...
    BOOL WINAPI My_CreateProcessW(
        ...
        Post_CreateProcessW(lpApplicationName, lpCommandLine, lpProcessAttributes, lpThreadAttributes, bInheritHandles, dwCreationFlags, lpEnvironment, lpCurrentDirectory, lpStartupInfo, lpProcessInformation);
        return res;
